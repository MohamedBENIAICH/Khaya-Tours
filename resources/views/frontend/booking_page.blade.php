    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow-lg">
                <div class="card-header bg-primary text-white">Book Destination: {{ $destination->city }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('confirm.booking', ['id' => $destination->id]) }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">Your Phone Number</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <p>You need to <a href="{{ route('login') }}">login</a> to proceed with payment.</p>
                            </div>
                        </div>
                        @endif
                    </form>
